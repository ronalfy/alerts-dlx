...
/* harmony import */ var _components_AlertLibraryPanel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/AlertLibraryPanel */ "./src/js/blocks/components/AlertLibraryPanel.js");
...
function CanonicalAlertEdit(props) {
  ...
  var appearanceLocked = Number(attributes.globalStyleId) > 0;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.InspectorControls, null, /*#__PURE__*/React.createElement(_components_AlertLibraryPanel__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    help: appearanceLocked ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Detach the global style to change the design system.', 'alerts-dlx') : undefined,
...
function createGoalFirstCanonicalVariations() {
  var defaultPurpose = 'success';
  var alertGroup = commonAttributes.alertGroup;
  return goals.map(function (goal) {
    ...
    var attributes = _objectSpread(_objectSpread({}, commonAttributes), {}, {
      purpose: goal.name,
      alertType: alertType,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AlertLibraryPanel)
/* harmony export */ });
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
 ...
 */
function AlertLibraryPanel(_ref) {
  var attributes = _ref.attributes,
    setAttributes = _ref.setAttributes;
  var items = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
    return (0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.getLocalizedLibraryItems)();
  }, []);
  var globalStyles = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
    return items.filter(function (item) {
      return item.kind === 'global_style';
    });
  }, [items]);
  var snapshots = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () {
    return items.filter(function (item) {
      return item.kind === 'snapshot';
    });
  }, [items]);
  var _useState = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(snapshots[0] ? String(snapshots[0].id) : ''),
    _useState2 = _slicedToArray(_useState, 2),
    selectedSnapshotId = _useState2[0],
    setSelectedSnapshotId = _useState2[1];
  var globalStyleId = Number(attributes.globalStyleId) || 0;
  var attachedStyle = (0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.findLibraryItem)(globalStyleId, 'global_style');
  var manageLibrary = (0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.canManageLibrary)();
  var globalStyleOptions = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('None', 'alerts-dlx'),
    value: '0'
  }].concat(_toConsumableArray(globalStyles.map(function (item) {
    return {
      label: item.title,
      value: String(item.id)
    };
  })));
  var snapshotOptions = snapshots.length ? snapshots.map(function (item) {
    return {
      label: item.title,
      value: String(item.id)
    };
  }) : [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('No snapshots yet.', 'alerts-dlx'),
    value: ''
  }];
   ...
   */
  var detachGlobalStyle = function detachGlobalStyle() {
    var resolved = (0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.mergeGlobalStyleIntoAttributes)(attributes);
    setAttributes((0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.buildDetachGlobalStyleAttributes)(resolved));
  };
  var onGlobalStyleChange = function onGlobalStyleChange(value) {
    var nextId = Number(value) || 0;
    if (!nextId) {
      detachGlobalStyle();
      return;
    }
    setAttributes({
      globalStyleId: nextId
    });
  };
  var applySnapshot = function applySnapshot() {
    var snapshotId = Number(selectedSnapshotId) || 0;
    var item = (0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.findLibraryItem)(snapshotId, 'snapshot');
    if (!item) {
      return;
    }
    setAttributes((0,_utils_alert_library_utils__WEBPACK_IMPORTED_MODULE_3__.buildSnapshotApplyAttributes)(item.config, attributes.className || ''));
  };
  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Library', 'alerts-dlx'),
    initialOpen: false
  }, attachedStyle && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.Notice, {
    status: "info",
    isDismissible: false
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)(/* translators: %s: global style title. */
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('This alert follows %s.', 'alerts-dlx'), attachedStyle.title)), !globalStyles.length ? /*#__PURE__*/React.createElement("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('No global styles yet.', 'alerts-dlx')) : /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Global style', 'alerts-dlx'),
    value: String(globalStyleId),
    options: globalStyleOptions,
    onChange: onGlobalStyleChange,
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('This alert follows the selected global style. Changes to that style update this alert. Title, description, and button text stay on this block.', 'alerts-dlx'),
    __nextHasNoMarginBottom: true
  }), globalStyleId > 0 && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.Button, {
    variant: "secondary",
    onClick: detachGlobalStyle,
    style: {
      marginBottom: '1rem'
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Detach', 'alerts-dlx')), !snapshots.length ? /*#__PURE__*/React.createElement("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('No snapshots yet.', 'alerts-dlx')) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Snapshot', 'alerts-dlx'),
    value: selectedSnapshotId,
    options: snapshotOptions,
    onChange: setSelectedSnapshotId,
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Applying a snapshot copies its settings into this alert. Later edits to the snapshot will not change it.', 'alerts-dlx'),
    __nextHasNoMarginBottom: true
  }), /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.Button, {
    variant: "primary",
    onClick: applySnapshot,
    disabled: !selectedSnapshotId
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Apply snapshot', 'alerts-dlx'))), manageLibrary && (!globalStyles.length || !snapshots.length) && /*#__PURE__*/React.createElement("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Create global styles and snapshots under Settings → AlertsDLX → Styles & Snapshots.', 'alerts-dlx')));
}
...
function AlertTypeStyleControl(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.BaseControl, {
    ...
    help: disabled ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Detach the global style to change alert styles.', 'alerts-dlx') : undefined,
    __nextHasNoMarginBottom: true
  }, /*#__PURE__*/React.createElement("div", {
...
function isAppearanceLocked(attributes) {
  return Number(attributes === null || attributes === void 0 ? void 0 : attributes.globalStyleId) > 0;
}
function MaximumWidthControls(_ref) {
  ...
  var maximumWidth = attributes.maximumWidth,
    maximumWidthUnit = attributes.maximumWidthUnit;
  var locked = isAppearanceLocked(attributes);
...
function HistoricalAlertVariantControl(_ref) {
  ...
  var locked = Number(attributes === null || attributes === void 0 ? void 0 : attributes.globalStyleId) > 0;
  return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.BaseControl, {
...
var withAlertStyleToolbar = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(function (BlockEdit) {
  return function (props) {
    ...
    var alertType = attributes.alertType,
      className = attributes.className,
      alertGroup = attributes.alertGroup,
      globalStyleId = attributes.globalStyleId;
    var appearanceLocked = Number(globalStyleId) > 0;
    var _useMemo = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
  ...
  render: function render() {
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Fill, {
      ...
      var colorPrimary = attributes.colorPrimary,
        ...
        colorBold = attributes.colorBold,
        colorLight = attributes.colorLight;
      var onColorChange = function onColorChange(key) {
...
/***/ "./src/js/blocks/plugins/global-style-resolution.js":
/*!**********************************************************!*\
  !*** ./src/js/blocks/plugins/global-style-resolution.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_0__.addFilter)('editor.BlockEdit', 'alerts-dlx/global-style-resolution', withGlobalStyleResolution, 20);
  ...
  render: function render() {
    return /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.Fill, {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.PanelRow, null, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.__experimentalToggleGroupControl, {
        ...
        help: appearanceLocked ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Detach the global style to change the icon.", "alerts-dlx") : "icon" === iconSource ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Select an icon below, or click the icon in the alert.", "alerts-dlx") : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("An image is displayed in the alert. You can edit the image by changing the image below.", "alerts-dlx")
      ...
      }))), "icon" === iconSource && !appearanceLocked && /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_0__.PanelRow, null, /*#__PURE__*/React.createElement("div", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GLOBAL_STYLE_BLOCK_KEYS: () => (/* binding */ GLOBAL_STYLE_BLOCK_KEYS),
/* harmony export */   SNAPSHOT_BLOCK_KEYS: () => (/* binding */ SNAPSHOT_BLOCK_KEYS),
/* harmony export */   buildDetachGlobalStyleAttributes: () => (/* binding */ buildDetachGlobalStyleAttributes),
/* harmony export */   buildSnapshotApplyAttributes: () => (/* binding */ buildSnapshotApplyAttributes),
/* harmony export */   canManageLibrary: () => (/* binding */ canManageLibrary),
/* harmony export */   createGuardedLibrarySetAttributes: () => (/* binding */ createGuardedLibrarySetAttributes),
/* harmony export */   findLibraryItem: () => (/* binding */ findLibraryItem),
/* harmony export */   getLocalizedLibraryItems: () => (/* binding */ getLocalizedLibraryItems),
/* harmony export */   libraryConfigToBlockAttributes: () => (/* binding */ libraryConfigToBlockAttributes),
/* harmony export */   mergeGlobalStyleIntoAttributes: () => (/* binding */ mergeGlobalStyleIntoAttributes),
/* harmony export */   resolveGlobalStyleAttributes: () => (/* binding */ resolveGlobalStyleAttributes)
/* harmony export */ });
/* harmony import */ var _alert_style_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alert-style-utils */ "./src/js/blocks/utils/alert-style-utils.js");
 ...
 */
var GLOBAL_STYLE_BLOCK_KEYS = ['alertGroup', 'alertType', 'variant', 'mode', 'maximumWidth', 'maximumWidthUnit', 'baseFontSize', 'iconSource', 'iconAppearance', 'iconVerticalAlignment', 'icon', 'imageUrl', 'imageId', 'colorPrimary', 'colorBorder', 'colorAccent', 'colorAlt', 'colorAltHover', 'colorAltText', 'colorAltTextHover', 'colorBold', 'colorLight', 'className'];

/**
 * Snapshot allowlist as camelCase block attributes (appearance plus snapshot-only).
 */
var SNAPSHOT_BLOCK_KEYS = [].concat(_toConsumableArray(GLOBAL_STYLE_BLOCK_KEYS.filter(function (key) {
  return 'className' !== key;
})), ['align', 'titleEnabled', 'descriptionEnabled', 'buttonEnabled', 'closeButtonEnabled', 'closeButtonExpiration', 'className']);
var SNAKE_TO_CAMEL = {
...
function getLocalizedLibraryItems() {
  ...
  var items = globalThis.alertsDlxBlock.libraryItems;
 ...
 */
function libraryConfigToBlockAttributes() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var allowlist = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : GLOBAL_STYLE_BLOCK_KEYS;
  var existingClassName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  var allowed = new Set(allowlist);
  var attributes = {};
  for (var _i = 0, _Object$entries = Object.entries(SNAKE_TO_CAMEL); _i < _Object$entries.length; _i++) {
    var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
      snake = _Object$entries$_i[0],
      camel = _Object$entries$_i[1];
  ...
  if (Object.prototype.hasOwnProperty.call(attributes, 'alertType') && allowed.has('className')) {
    attributes.className = (0,_alert_style_utils__WEBPACK_IMPORTED_MODULE_0__.buildAlertStyleClassName)(existingClassName || '', attributes.alertType);
  }
  return attributes;
}
 ...
 * @return {Object|null}
 */
function findLibraryItem(id, kind) {
  var numericId = Number(id) || 0;
  if (!numericId) {
    return null;
  }
  return getLocalizedLibraryItems().find(function (item) {
    return item && Number(item.id) === numericId && item.kind === kind && item.config && _typeof(item.config) === 'object';
  }) || null;
}
 ...
 */
function resolveGlobalStyleAttributes(globalStyleId) {
  var existingClassName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var item = findLibraryItem(globalStyleId, 'global_style');
  if (!item) {
    return {};
  }
  return libraryConfigToBlockAttributes(item.config, GLOBAL_STYLE_BLOCK_KEYS, existingClassName);
}
 ...
 */
function mergeGlobalStyleIntoAttributes() {
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var styleAttributes = resolveGlobalStyleAttributes(attributes.globalStyleId, attributes.className || '');
  if (!Object.keys(styleAttributes).length) {
    return attributes;
  }
  return _objectSpread(_objectSpread({}, attributes), styleAttributes);
}
 ...
 * @return {Object}
 */
function buildSnapshotApplyAttributes() {
  var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var existingClassName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return _objectSpread(_objectSpread({}, libraryConfigToBlockAttributes(config, SNAPSHOT_BLOCK_KEYS, existingClassName)), {}, {
    globalStyleId: 0
  });
}
 ...
 * @return {Object}
 */
function buildDetachGlobalStyleAttributes() {
  var attributes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var patch = {
    globalStyleId: 0
  };
  var _iterator = _createForOfIteratorHelper(GLOBAL_STYLE_BLOCK_KEYS),
    _step;
  try {
 ...
 */
function createGuardedLibrarySetAttributes(attributes, setAttributes) {
  return function () {
    var updates = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    if (!updates || _typeof(updates) !== 'object') {
      return;
    }
    var unlocking = Object.prototype.hasOwnProperty.call(updates, 'globalStyleId') && !Number(updates.globalStyleId);
    var attaching = Object.prototype.hasOwnProperty.call(updates, 'globalStyleId') && Number(updates.globalStyleId) > 0;
    var currentlyLocked = Number(attributes.globalStyleId) > 0;

    // Selecting another global style stores the reference only.
    if (attaching) {
      setAttributes({
        globalStyleId: Number(updates.globalStyleId)
      });
      return;
    }
    ...
    var filtered = _objectSpread({}, updates);
    var _iterator2 = _createForOfIteratorHelper(GLOBAL_STYLE_BLOCK_KEYS),
      _step2;
    try {
...
/* harmony import */ var _js_blocks_plugins_global_style_resolution__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./js/blocks/plugins/global-style-resolution */ "./src/js/blocks/plugins/global-style-resolution.js");
/* harmony import */ var _js_blocks_components_icons_AlertsLogo__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./js/blocks/components/icons/AlertsLogo */ "./src/js/blocks/components/icons/AlertsLogo.js");
...
(function () {
  wp.blocks.updateCategory("alertsdlx", {
    icon: /*#__PURE__*/React.createElement(_js_blocks_components_icons_AlertsLogo__WEBPACK_IMPORTED_MODULE_16__["default"], {
      width: 16,
      height: 16
    })
  });
